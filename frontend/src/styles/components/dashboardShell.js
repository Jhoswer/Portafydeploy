export const dashboardShell = {
  page: {
    ...
    background: "linear-gradient(180deg, var(--dashboard-page-start, rgba(246,250,255,.42)) 0%, var(--dashboard-page-mid, rgba(240,248,255,.58)) 52%, var(--dashboard-page-end, rgba(234,245,252,.74)) 100%)",
  },
  container: {
    width: "100%",
    maxWidth: 1360,
  ...
  surfaceCard: {
    background: "var(--dashboard-card-bg, #ffffff)",
    border: "1px solid var(--dashboard-card-border, rgba(205, 225, 245, 0.6))",
    borderRadius: 22,
    boxShadow: "0 6px 20px rgba(14,30,60,.05)",
  },
  softPanel: {
    background: "var(--dashboard-soft-bg, #fbfdff)",
    border: "1px solid var(--dashboard-card-border, rgba(205, 225, 245, 0.7))",
    borderRadius: 18,
    boxShadow: "0 4px 16px rgba(14,30,60,.035)",
  },
  heroCard: {
    background: "var(--dashboard-card-bg, #ffffff)",
    border: "1px solid var(--dashboard-card-border, rgba(205,225,245,.68))",
    borderRadius: 24,
  ...
  badge: {
    ...
    borderRadius: 999,
    background: "var(--dashboard-soft-bg, #fbfdff)",
    border: "1px solid var(--dashboard-card-border, rgba(205,225,245,.76))",
    fontFamily: "var(--f-ui)",
    fontSize: "0.78rem",
    fontWeight: 700,
    color: "var(--body)",
  ...
  iconBadge: {
    ...
    background: "var(--dashboard-icon-bg, rgba(239,246,255,.82))",
    border: "none",
