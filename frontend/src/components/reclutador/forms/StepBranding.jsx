  ...
  return (
    <StepWrapper stepKey="paso-branding">
      ...
      <h2 className="forms-card__title" style={{ textAlign: "center" }}>
        {t("recruiterForms.stepBranding.title")}
      </h2>
      <p className="forms-card__sub" style={{ textAlign: "center", marginBottom: 24 }}>
        {t("recruiterForms.stepBranding.subtitle")}
        <OptionalBadge />
      </p>
      ...
      {logoPreview ? (
        <div style={{ width: "100%", textAlign: "center", marginBottom: 12 }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 14 }}>
            ...
            >
              <ImageUp size={12} /> {t("recruiterForms.stepBranding.preview.change")}
            </button>
            ...
            >
              <X size={12} /> {t("recruiterForms.stepBranding.preview.remove")}
            </button>
          </div>
        </div>
      ) : (
        <div onClick={() => setCropOpen(true)} style={{
          ...
          <p style={{
            ...
            {t("recruiterForms.stepBranding.dropzone.heading")}
          </p>
          <p style={{ fontSize: 12, color: "var(--color-muted-text)", fontFamily: "var(--font-body)" }}>
            {t("recruiterForms.stepBranding.dropzone.hint")}
          </p>
        </div>
      )}
